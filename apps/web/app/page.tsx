    ...
    <div className="flex flex-col min-h-screen bg-neutral-50">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="space-y-6 text-neutral-700 leading-relaxed">
              <p>
                We met in the fall of 2018 at a coffee shop in San Francisco. What started as a
                chance encounter over a shared love of cappuccinos quickly blossomed into something
                extraordinary.
              </p>
              <p>
                Five years later, on a trip to Big Sur, Enrique got down on one knee at sunset
                overlooking the Pacific Ocean. Through tears of joy, Anna said yes.
              </p>
              <p>
                Now we're excited to celebrate our love with the people who matter most to us.
                Join us for a weekend of joy, laughter, and unforgettable memories.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border border-neutral-200">
              <div className="text-center space-y-4">
                ...
                <h3 className="text-2xl font-serif text-neutral-900">Ceremony</h3>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border border-neutral-200">
              <div className="text-center space-y-4">
                ...
                <h3 className="text-2xl font-serif text-neutral-900">Reception</h3>
                <div className="text-neutral-600 space-y-2">
          ...
          <div className="mt-12 bg-white p-8 rounded-lg shadow-sm border border-neutral-200">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                <h4 className="font-semibold text-neutral-900 mb-2">Attire</h4>
                <p className="text-neutral-600 text-sm">Formal / Black Tie Optional</p>
              </div>
              <div>
                <h4 className="font-semibold text-neutral-900 mb-2">Accommodations</h4>
                <p className="text-neutral-600 text-sm">Hotel blocks available</p>
              </div>
              <div>
                <h4 className="font-semibold text-neutral-900 mb-2">Registry</h4>
      ...
      <section id="schedule" className="py-24 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8">
            {[
              { id: "arrival", time: "3:30 PM", event: "Guest Arrival", description: "Please arrive early to find your seats" },
              { id: "ceremony", time: "4:00 PM", event: "Ceremony Begins", description: "The celebration starts" },
              { id: "cocktail", time: "4:30 PM", event: "Cocktail Hour", description: "Drinks and hors d'oeuvres in the garden" },
              { id: "reception", time: "6:00 PM", event: "Reception", description: "Dinner, toasts, and dancing" },
              { id: "lastdance", time: "10:00 PM", event: "Last Dance", description: "Send off under the stars" },
            ].map((item) => (
              <div key={item.id} className="flex gap-6 items-start border-l-2 border-neutral-200 pl-6">
                <div className="min-w-[100px] pt-1">
                  <p className="font-semibold text-neutral-900">{item.time}</p>
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-serif text-neutral-900 mb-1">{item.event}</h3>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <form className="space-y-6">
              ...
              <div className="text-left">
                <label htmlFor="attending" className="block text-sm font-medium text-neutral-700 mb-2">
                  Will you be attending?
                </label>
                <select id="attending" className="w-full px-4 py-2 border border-neutral-300 rounded-md focus:ring-2 focus:ring-neutral-900 focus:border-transparent outline-none">
      ...
      <footer className="py-12 px-6 bg-white border-t border-neutral-200">
        <div className="max-w-4xl mx-auto text-center space-y-4">
            <p className="text-2xl font-serif text-neutral-900">We can't wait to celebrate with you!</p>
            <p className="text-neutral-600 text-sm">
              For questions, please contact us at{" "}
              <a href="mailto:wedding@example.com" className="underline hover:text-neutral-900">
                wedding@example.com
              </a>
            </p>
